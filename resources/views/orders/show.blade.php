            ...
            <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
                ...
                <div class="mb-6 sm:mb-8">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-4">
                        ...
                        <span class="px-3 sm:px-4 py-1 sm:py-2 rounded-full font-semibold text-sm sm:text-base w-fit
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                            ...
                            <form action="{{ route('orders.cancel', $order) }}" method="POST" class="inline">
                                ...
                                <button type="submit"
                                    ...
                                    class="w-full sm:w-auto px-4 sm:px-6 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors text-sm sm:text-base">
                                    Batalkan Pesanan
                                </button>
                            </form>
                            @endif
