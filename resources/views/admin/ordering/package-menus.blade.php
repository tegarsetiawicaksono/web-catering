...
<div class="max-w-6xl mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Kelola Urutan Package Menu</h1>
        <p class="text-gray-600 mt-2">Atur urutan tampilan package menu di halaman</p>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Package</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse ($packageMenus as $index => $item)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                            <div class="flex justify-center gap-2">
                                @if ($index > 0)
                                    <form action="{{ route('admin.ordering.package-menus.update-order', $item) }}" method="POST" class="inline">
                                        @csrf
