                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <span class="text-sm font-bold text-gray-900">Rp {{ number_format($transaction->total_price, 0, ',', '.') }}</span>
                            </td>
                ...
                <div class="p-4 hover:bg-gray-50">
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            ...
                            <span class="ml-2 px-2 py-1 inline-flex text-xs leading-4 font-semibold rounded-full bg-green-100 text-green-800">
                                Completed
                            </span>
                        </div>
                        <a href="{{ route('admin.orders.show', $transaction) }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between items-center pt-2 border-t border-gray-100">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-base font-bold text-gray-900">Rp {{ number_format($transaction->total_price, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
