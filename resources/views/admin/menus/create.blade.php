                ...
                <form action="{{ route('admin.menus.store') }}" method="POST" enctype="multipart/form-data" class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4" required
                            class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('deskripsi') border-red-300 @enderror">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="number" name="harga" id="harga" value="{{ old('harga') }}" min="0" step="1000" required
                        ...
                        <div>
                            ...
                            <input type="number" name="min_order" id="min_order" value="{{ old('min_order', 50) }}" min="1" required
