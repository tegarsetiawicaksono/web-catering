...
<div x-data="{
    ...
    init() {
        window.addEventListener('show-notification', (e) => {
            this.notifications.push({ message: e.detail.message, id: Date.now() });
            this.show = true;
            this.autoHide();
        });
    },
    ...
    <template x-for="(notif, idx) in notifications" :key="notif.id">
        <div class="bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center space-x-3 relative">
