            ...
            <div class="md:hidden relative" x-data="{ 
                ...
                <div x-ref="scrollContainer" class="overflow-x-auto hide-scrollbar snap-x snap-mandatory px-2">
                    <div class="flex gap-6 pb-4">
                        @php
                        $packages = [
                        ['name' => 'Silver', 'price' => '35.000', 'route' => 'silver'],
                        ['name' => 'Gold', 'price' => '40.000', 'route' => 'gold'],
                        ['name' => 'Platinum', 'price' => '45.000', 'route' => 'platinum']
                        ];
                        @endphp
                        ...
                        <div class="flex-shrink-0 w-80 snap-center" x-data="{ showMenu: false }">
                            <div class="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl overflow-hidden h-full border border-white/50">
                                <div class="relative">
                                    <img src="{{ asset('foto/buffet.jpg') }}" alt="Paket {{ $pkg['name'] }}" class="w-full h-48 object-cover">
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
                                        <h3 class="text-2xl font-bold text-white drop-shadow-lg">Paket {{ $pkg['name'] }}</h3>
                                    </div>
                                </div>
                                <div class="p-5">
                                    <!-- Toggle Button -->
                                    ...
                                    <div x-show="showMenu"
                                        ...
                                        class="mb-4 bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-4 border border-orange-200 space-y-3">
