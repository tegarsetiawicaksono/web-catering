                                ...
                                <div class="p-4 sm:p-5">
                                    ...
                                    <div class="mt-4 sm:mt-5 space-y-2">
                                        ...
                                        <a href="{{ route('checkout.show') }}?package=buffet&name={{ urlencode($menu->nama) }}&price={{ $menu->harga }}&min={{ $menu->min_order }}&menu_id={{ $menu->id }}"
                                            class="block w-full bg-gradient-to-r from-orange-500 to-amber-500 text-white py-2.5 sm:py-3 rounded-xl hover:shadow-lg transition-all duration-300 text-sm sm:text-base font-bold text-center">
                                        ...
                                        <form action="{{ route('cart.store') }}" method="POST">
                                            ...
                                            <button type="submit"
                                                class="w-full bg-white border-2 border-orange-500 text-orange-500 py-2.5 sm:py-3 rounded-xl hover:bg-orange-50 transition-all duration-300 text-sm sm:text-base font-semibold">
                                                <span class="flex items-center justify-center gap-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <a href="https://wa.me/6282227110771?text=Halo%2C%20saya%20tertarik%20dengan%20{{ urlencode($menu->nama) }}"
                                            target="_blank"
                                            class="block w-full bg-white border-2 border-green-500 text-green-500 py-2.5 sm:py-3 rounded-xl hover:bg-green-50 transition-all duration-300 text-sm sm:text-base font-semibold text-center">
