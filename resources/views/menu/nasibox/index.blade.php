...
<div class="min-h-screen pt-16 relative">
    ...
    <div class="fixed inset-0 z-0">
        <img src="{{ asset('foto/nasibox.jpg') }}" alt="Background" class="w-full h-full object-cover">
    ...
    <div class="relative">
        ...
        <div class="absolute inset-0 z-0">
            <img src="{{ $category && $category->gambar_background ? asset($category->gambar_background) : asset('foto/nasibox.jpg') }}" alt="Nasi Box Background" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 py-20">
            <div class="container mx-auto px-4">
                <h1 class="text-4xl md:text-5xl font-bold mb-4 text-white drop-shadow-lg">Paket Nasi Box</h1>
                <p class="text-lg text-white/90 max-w-2xl drop-shadow-md">Paket nasi box praktis untuk acara dan meeting Anda</p>
            </div>
        </div>
    </div>
    ...
    <div class="relative z-10">
        <div class="container max-w-7xl mx-auto px-4 py-16">
            ...
            <div class="text-center py-12">
                <p class="text-gray-600 text-lg">Belum ada menu nasi box tersedia</p>
            </div>
            @else
                        ...
                        <div class="flex-shrink-0 w-80 snap-center" x-data="{ showMenu: false }">
                            <div class="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl overflow-hidden h-full border border-white/50">
                                <div class="relative">
                                    ...
                                    @else
                                    <img src="{{ asset('foto/nasibox.jpg') }}" alt="{{ $menu->nama }}" class="w-full h-48 object-cover">
                                    @endif
